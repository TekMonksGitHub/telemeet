...
FILES="$MONKSHU_PATH/backend/apps/telemeet/conf/telemeet.json $MONKSHU_PATH/frontend/apps/telemeet/js/constants.mjs $MONKSHU_PATH/../monkshu/backend/server/conf/blackboard.json"
