/*! For license information please see external_api.min.js.LICENSE.txt */ ! function(e, t) {
		...
		var e = {
					...
					class v {
						constructor() {
							...
							this.postis = function(e) {
								...
								...m,
								...e
							}), this._receiveCallback = () => {}, this.postis.listen(f, (e => this._receiveCallback(e)))
						}
						dispose() {
							this.postis.destroy()
						}
					...
					class I extends(i()) {
						constructor(e) {
							...
							this._parentNode = c, this._url = function(e) {
								...
								release: w
							}), LOG.info("*********Here 2"), this._createIFrame(a, s, p), LOG.info("*********Here 3"), this._transport = new b({
								backend: new v({
									postisOptions: {
							...
							}), LOG.info("*********Here 4"), Array.isArray(m) && m.length > 0 && this.invite(m), this._tmpE2EEKey = _, this._isLargeVideoVisible = !0, this._numberOfParticipants = 0, this._participants = {}, this._myUserID = void 0, this._onStageParticipant = void 0, this._setupListeners(), R++
						}
						_createIFrame(e, t, n) {
							...
							this._transport.on("event", (e => {
								...
								switch (t) {
									case "video-conference-joined":
										void 0 !== this._tmpE2EEKey && (this.executeCommand(C.e2eeKey, this._tmpE2EEKey), this._tmpE2EEKey = void 0), this._myUserID = r, LOG.info("******* Video conf joined"), this._participants[r] = {
				...
				7: e => {
					...
					function s() {
						...
						if (!(t[s] < e.level))
							for (var a = !(e.options.disableCallerInfo || r.disableCallerInfo) && i(), c = n.concat(e.transports), l = 0; l < c.length; l++) {
								var d = c[l],
									u = d[s];
